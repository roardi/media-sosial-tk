<?php
	...
	$id = $_SESSION['member_id'];
		if(isset($_POST['share'])){
			...
			mysqli_query($con,"INSERT INTO groupposts(group_id,member_id,posts,date,status) VALUE ('$id','$id','$post',NOW(),'$id')")or die(mysqli_error());}}
		}
					...
					<ul>
							<?php 
								...
								while ($row = mysqli_fetch_array($group)){
									...
									echo '<li> <a href=memberprofile.php?id='.$rows["member_id"].' style = "text-decoration:none;"><img src="image/members/'. $rows['photo'].'" height="50" width="50"><br>'.$rows['firstname'].' '.$rows['lastname'].' </a></li>';
                ...
                <div class="art-blockcontent">
					...
					<ul>
							<?php
								...
								$post = mysqli_query($con,"SELECT * FROM groupposts WHERE group_id = '$id' ORDER by date DESC LIMIT 0,5")or die(mysqli_error());
							...
							<div>
								<form method="post" action="">
									<?php
											...
											echo "<a href='grouphome.php' style='text-decoration:none;'>".$row['group_name']."</a>"."<br />"."&nbsp;&nbsp;&nbsp;&nbsp;<img src='image/groups/".$row['photo']."'width='120px' height='120px'>";
						...
						<div class="cleared"></div>
							...
							<?php	
										...
										echo "<input type='hidden' value='".$row['grouppost_id']."' name='cantseeme'/>
											<div>
												<div class='picofjoke'><img src='image/members/".$photo."' width='50' height ='50' alt=''/>".$name.",</div><div class = 'postcon'><br />
